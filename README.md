...
1. Hemaxi, N., et al. (2024). *Deep Learning for ECG Classification: A Comparative Study of 1D and 2D Representations...* 
2. Shaik, S., et al. (2023). *Classification of ECG Signal Using FFT-Based Improved AlexNet Classifier* 
3. Pałczyński, K., et al. (2022). *Few-Shot Learning for ECG Classification* 
